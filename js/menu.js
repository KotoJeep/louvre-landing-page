const burger = document.getElementById('burger'),
	mrMenu = document.getElementById('mr-menu'),
...
document.addEventListener('click', function (e) {
	...
	const mrMenuLinks = document.querySelectorAll('.mr-menu__link');
	let its_link = false;
	...
	if (
		(mrMenu.classList.contains('mr-menu_is-opened') && mrMenu.classList.contains('mr-menu_is-closed')) ||
		(!mrMenu.classList.contains('mr-menu_is-opened') && !mrMenu.classList.contains('mr-menu_is-closed')) ||
		(its_menu && !its_link)
	)
		return;
